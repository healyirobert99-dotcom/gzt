...
def test_p_static_contract():
    ...
    # v1.0.8：当前版本号契约随版本升级前移（test_v107 自身语义不变，仅契约值更新）。
    step('§P#1 TARGET_SCHEMA_VERSION=1.0.8',
         "'1.0.8'" in server_py and "TARGET_SCHEMA_VERSION = '1.0.8'" in server_py)
    step('§P#2 server_version 头=1.0.8',
         "server_version = 'Workbench/1.0.8'" in server_py)
