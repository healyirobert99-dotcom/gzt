"""生成 A/H 投研交易工作台 v1.0.3 交付审计文档（docx）。
...
OUT_PATH = os.path.join(OUT_DIR, 'A-H投研交易工作台交付审计文档-v1.0.3.docx')
...
add_table(doc, ['类型', '文件', '说明'], [
    ...
    ['新增', 'A-H投研交易工作台交付审计文档-v1.0.3.docx', '本文件'],
...
# ================ §11 风险登记册 ================
add_h(doc, '11. 风险登记册（v1.0.3 增量）', 1)
...
# ================ §12 第三方审计重点 ================
add_h(doc, '12. 第三方审计重点（v1.0.3 增量）', 1)
...
# 保存
doc.save(OUT_PATH)
print(f'✅ v1.0.3 docx 生成：{OUT_PATH}')
